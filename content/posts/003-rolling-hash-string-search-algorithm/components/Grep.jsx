...
import ExampleWrapper from '../../../../src/components/Example-Wrapper.jsx';

export default function Grep({ func, funcName }) {
  ...
  return (
    <ExampleWrapper
      name={`<GrepComponent func={${funcName}}/>`}
      css={css`
        input {
          margin-right: 1em;
          width: 30%;
    ...
    >
      <p>
        ...
        />{' '}
        Needle:{' '}
        <input placeholder="needle" value={needle} onChange={e => setNeedle(e.target.value)} />
      </p>
      <p
